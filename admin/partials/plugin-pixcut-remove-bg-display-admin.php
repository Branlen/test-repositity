            ...
            <tr valign="center">
                ...
                <td>
                    <div class="table-content">
                        <input type="text" class="input" style="width: 60%" name="Pixcut_RemoveBG_ApiKey" value="<?php echo esc_attr(get_option('Pixcut_RemoveBG_ApiKey')) ?>" />
                    </div>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <div class="table-content">
                        ...
                        <input type="text" class="input  mt-2" style="width: 60%;" <?php if ('specified' != get_option('Pixcut_RemoveBG_products')) echo ' readonly disable'; ?> placeholder="4,156,271" name="Pixcut_RemoveBG_products_IDs" value="<?php echo esc_attr(get_option('Pixcut_RemoveBG_products_IDs')) ?>" />
                    </div>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    <div class="table-content">
                        ...
                        <input type="checkbox" id="target_gallery" name="Pixcut_RemoveBG_gallery" value="1" <?php echo checked(1 == get_option('Pixcut_RemoveBG_gallery'), true, false) ?> /><label for="target_gallery">Product gallery</label>
                    </div>
                </td>
            </tr>
            <tr valign="center">
                ...
                <td>
                    ...
                    <div class="table-content">
                        <input type="checkbox" class="mb-0" name="Pixcut_RemoveBG_Include_Processed" value="1" <?php echo checked(1 == get_option('Pixcut_RemoveBG_Include_Processed'), true, false) ?> />
                    </div>
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    ...
                    <div class="table-content">
                        ...
                        <input type="radio" id="newbg_color" name="Pixcut_RemoveBG_Background" value="color" <?php echo checked('color' == get_option('Pixcut_RemoveBG_Background'), true, false) ?> /><label for="newbg_color" style="height: 27px;line-height: 27px;"> Color </label>
